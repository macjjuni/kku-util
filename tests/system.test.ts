...
describe('systemUtil', () => {
    ...
    describe('getOS', () => {
        ...
        it('should return "Android" for Android user agent', () => {
            // Arrange
            Object.defineProperty(navigator, 'userAgent', {
                value: 'Mozilla/5.0 (Linux; Android 10; Pixel 3 XL Build/QP1A.190711.020) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Mobile Safari/537.36',
                configurable: true,
            });
            const os = getOS();
    ...
    describe('getBrowser', () => {
        ...
        it('should return "Edge" for Edge user agent', () => {
            // Arrange
            Object.defineProperty(navigator, 'userAgent', {
                value: 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.864.41 Safari/537.36 Edg/91.0.864.41',
                configurable: true,
            });
            const browser = getBrowser();
        ...
        it('should return "Opera" for Opera user agent', () => {
            // Arrange
            Object.defineProperty(navigator, 'userAgent', {
                value: 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 OPR/77.0.4054.254 Safari/537.36',
                configurable: true,
            });
            const browser = getBrowser();
